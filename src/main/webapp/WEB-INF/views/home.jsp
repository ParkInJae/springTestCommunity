	...
	<sec:authorize access="isAuthenticated()">
		<div style="font-size:18px; text-decoration: none; color:black; font-weight: bold;">
			...
			<table class="mainTable">
		        <tr>
		            <th class="existValue"><a href="user/notice/list.do"></a>공지사항</th>
		            <th>|</th>
		            <th class="existValue"><a href="board/list.do">사내 커뮤니티</a></th>
		            <th>|</th>
		            <th class="existValue"><a href="user/myDepartment.do">나의 부서 업무 상황</a></th>
		        </tr>
		    </table>
		    <!-- 출퇴근 관련 토글 생성해야함 -->
		    <button id="checkInButton" onclick="checkIn()">출퇴근 toggle</button>
		    <button id="checkOutButton" onclick="checkOut()">출퇴근 toggle</button>
		    <!-- 
		    	 geolocation과 ip 둘 중 하나 선택해야함 
		    -->
		   <script>
		   function checkIn(){
			    const gio = document.getElementById("status");
			    // geolocationAPI 지원 여부 확인 
